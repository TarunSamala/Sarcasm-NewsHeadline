...
with open(os.path.join(OUTPUT_DIR, 'classification_report-rf-glove.txt'), 'w') as f:
    f.write("Random Forest with GloVe Classification Report:\n")
    f.write(report)
...
plt.title('Random Forest with GloVe Confusion Matrix')
plt.ylabel('True Label')
plt.xlabel('Predicted Label')
plt.savefig(os.path.join(OUTPUT_DIR, 'confusion_matrix-rf-glove.png'), bbox_inches='tight', dpi=300)
plt.close()
